...
Большая часть клиентов являются членами клуба (92.7%), около 6.8% находятся в стадии оформления членства в клубе и очень маленькая доля - 0.0003% (467 клиентов) покинула клуб (эта группа вошла в "Other" вместе с неопределенными значениями)
...
Чуть больше трети клиентов (34.8%) подписаны на регулярные новости, 0.1% получают новости ежемесячно. Большая часть клиентов (65.1%) вообще не имеют подписки, что достаточно много и следует предпринимать шаги для сокращения этой группы. При этом новости не должны превращаться в спам. Это должно быть что-то связанное с модой, вызывающее интерес к просмотру и в идеале переход на сайт компании и покупку.
