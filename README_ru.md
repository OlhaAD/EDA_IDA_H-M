...
**Визуализация распределения количества продаж на одного клиента с помощью box plot**

Для более детального анализа было проведено распределение количества продаж на одного клиента по квартилям:
- **Первый квартиль (25-й процентиль):** Остается на уровне 3 для обоих периодов.
- **Медиана (50-й процентиль):** Падение с 8 до 7, что означает снижение покупательской активности.
- **Верхний квартиль (75-й процентиль):** Падение с 19 до 18, что также указывает на снижение активности среди топовых клиентов.
- **Максимальные значения:** Снижение максимальных значений покупок, что может свидетельствовать об изменении поведения самых активных клиентов или изменении ассортимента/ценовой политики.
...
Распределение суммы покупок на одного клиента показывает, что медиана и квартильные значения во втором периоде ниже, что указывает на общее снижение покупательской способности или готовности к покупкам у клиентов. При этом активность в покупках на небольшие суммы осталась на прежнем уровне, в то время как активность в покупках за год на большие суммы снизилась. Визуализация этих данных представлена на следующем графике:
...
- Данные о количестве продаж и статистике подтверждают снижение покупательской активности. Медиана снизилась с 8 до 7, что указывает на то, что 50% покупателей теперь покупают минимум на одну позицию меньше. Верхний квартиль также снизился с 19 до 18, что указывает на снижение активности среди топовых 25% клиентов. В совокупности, 75% покупателей демонстрируют тенденцию к уменьшению своих покупок. Максимальные значения показывают снижение экстремальных покупок, что может указывать на изменение в поведении самых активных клиентов или изменение в ассортименте/ценовой политике. Эти выводы требуют дальнейшего анализа причин снижения и разработки стратегий по увеличению продаж в будущем.
- Данные о количестве продаж и статистике подтверждают снижение покупательской активности. Общий оборот за год снизился на 9.05%, в то время как средняя сумма покупок на одного клиента снизилась на 7.87%. Распределение суммы покупок на одного клиента показывает, что медиана и квартильные значения во втором периоде ниже, что указывает на общее снижение покупательской способности или готовности к покупкам у клиентов. При этом активность в покупках на небольшие суммы осталась на прежнем уровне, в то время как активность в покупках на большие суммы за год снизилась.
